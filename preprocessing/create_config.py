...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--learning_rate', type=float, default=0.07, help="the learning rate")
    parser.add_argument('-s', '--seed', type=int, default=42, help="the seed for the random number generator")
    parser.add_argument('-p', '--p_reg', type=float, default=0.08, help="the regularization parameter for the user matrix")
    parser.add_argument('-q', '--q_reg', type=float, default=0.1, help="the regularization parameter for the item matrix")
    parser.add_argument('-u', '--user_bias_reg', type=float, default=0.003, help="the regularization parameter for the user biases")
    parser.add_argument('-i', '--item_bias_reg', type=float, default=0.003, help="the regularization parameter for the item biases")
